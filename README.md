...
L’objectif est de concevoir une application ludique permettant de comprendre comment un établissement scolaire peut réduire ses dépendances numériques, adopter des solutions libres et s’inscrire dans la démarche **NIRD** (Numérique Inclusif, Responsable et Durable).
